...
function HomeAssistantAirPurifier(log, data, client) {
  // device info
  this.domain = 'airpurifier';
  this.data = data;
...
HomeAssistantAirPurifier.prototype = {
...
function HomeAssistantAirPurifierPlatform(oService, oCharacteristic, oCommunicationError) {
  Service = oService;
  Characteristic = oCharacteristic;
  communicationError = oCommunicationError;

  return HomeAssistantAirPurifier;
}

module.exports = HomeAssistantAirPurifierPlatform;
module.exports.HomeAssistantAirPurifier = HomeAssistantAirPurifier;
